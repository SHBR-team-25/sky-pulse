...
TABLE_PATH = "//home/positions_current"
...
def get_schema():
    return TableSchema() \
        ...
        .add_column("time_position", ti.Int64) \
        ...
        .add_column("enriched_at", ti.Int64)
...
def main():
    parser = argparse.ArgumentParser(
        description="Create positions_current table in YTsaurus"
    )
    parser.add_argument(
        "--proxy",
