...
def main():
    ...
    parser.add_argument(
        "--window-seconds",
        type=int,
        default=AGGREGATE_CONFIG["window_seconds"],
    )
    parser.add_argument(
        "--position-freshness-seconds",
        type=int,
        default=AGGREGATE_CONFIG["position_freshness_seconds"],
    )
    ...
    parser.add_argument(
        "--interval",
        type=int,
        default=AGGREGATE_CONFIG["interval_seconds"],
    ...
    print(
        "Starting job_aggregate scheduler. "
