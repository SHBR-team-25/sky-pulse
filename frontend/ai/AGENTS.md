...
└───widgets                                       # слой самостоятельных блоков интерфейса
    ...
    └───flight-map                                # карта аэропортов и рейсов с маркерами, кластерами и деталями
        ...
        │
        └───ui
                AirportDetailsCard.tsx            # карточка аэропорта с общей информацией и списком рейсов
                AirportDetailsPopover.module.css  # стили поповера и карточки рейсов аэропорта
